process STAR_ALIGN {
    ...
    conda "bioconda::star=2.7.11a bioconda::samtools=1.16.1 conda-forge::gawk=5.1.0"
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/star-fusion:1.13.0--hdfd78af_1' :
        'quay.io/biocontainers/star-fusion:1.13.0--hdfd78af_1' }"
    ...
    def fusion_args = task.ext.args2 ?: ''
