...
# head(cmds)
length(cmds) #1
str_count(string = cmds, pattern = "&") # 102
cat(cmds, file = file.path(OUTDIR,"concat_fqs.sh"))
```

```{bash, eval=FALSE}
bash "$HOME/github_repos/2025.06.02_RNAseq_Bulk_T-ALL/data/fastq/concatenated/concat_fqs.sh"
```
